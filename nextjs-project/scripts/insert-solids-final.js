...
// Use a common slug to group all chunks from the same article
...
const chunks = [
  ...
  },
  {
    ...
    content: 'For preterm infants, use corrected age and the same readiness signs (head control, sitting, coordinated swallow). If there is growth faltering, neuromotor delay, or suspected swallowing dysfunction, consult the infant clinical team; a speech-language pathologist or feeding specialist may be needed. Decisions should remain individualized, but introduction before 4 months corrected age is generally discouraged.',
  ...
  },
  {
    ...
    source_id: crypto.randomUUID(),
    source_slug: ARTICLE_SLUG,
    title: 'Compliance and attribution (public-domain and licensing notes) + source links',
...
(async () => {
  ...
  console.log(`   Source article: ${ARTICLE_SLUG}`);
  console.log(`   Category: feeding-nutrition`);
  console.log(`   Status: All published`);
  console.log('\nNext step: Run "node scripts/generate-embeddings.js" to create embeddings for these chunks');
})();
