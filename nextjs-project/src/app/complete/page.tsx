...
export const metadata: Metadata = {
  title: 'Email Verified - Complete | JupitLunar',
  description: 'Your email has been verified successfully. Welcome to the Mom AI Agent community.',
  robots: {
    index: false,
    follow: false,
  },
...
export default function CompletePage() {
  return (
    <>
      ...
      <header className="relative mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-8 z-50">
        ...
        <nav className="hidden items-center gap-6 text-sm font-medium text-slate-500 md:flex">
          <Link className="transition hover:text-indigo-500" href="/">
            Home
          </Link>
          <Link className="transition hover:text-indigo-500" href="/products">
            Products
          </Link>
          <Link className="transition hover:text-indigo-500" href="/faq">
            FAQ
          </Link>
        </nav>
      </header>
      ...
      <footer className="relative border-t border-white/60 bg-white/70 py-6 backdrop-blur">
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center justify-between gap-4 px-6 text-xs text-slate-500 md:flex-row">
          ...
          <div className="flex items-center gap-4">
            <Link className="transition hover:text-indigo-500" href="/privacy">
              Privacy Policy
            </Link>
            <Link className="transition hover:text-indigo-500" href="/disclaimer">
              Terms of Service
            </Link>
