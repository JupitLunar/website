...
export default function SocialShare({ url, title, description }: SocialShareProps) {
  ...
  return (
    <div className="border-t border-slate-200 pt-6 mt-8">
      <h3 className="text-sm font-semibold text-slate-700 uppercase tracking-[0.2em] mb-4">
        Share this insight
      </h3>
      <div className="flex flex-wrap items-center gap-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg text-sm text-slate-600 transition-colors"
