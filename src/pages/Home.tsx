    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F8F6FC] to-[#EAE6F8] relative overflow-hidden text-center">
          ...
          <div className="w-full px-8 mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center justify-items-center">
              ...
              <div className="relative flex items-center justify-center h-full w-full">
                <div className="relative z-10 w-[660px] aspect-[4/3] translate-x-[66px] translate-y-8 mx-auto">
                  <motion.div 
      ...
      <section id="features" className="py-16 bg-white text-center">
        <div className="container mx-auto px-6 flex flex-col items-center">
          <div className="max-w-full mx-auto space-y-32 w-full flex flex-col items-center">
            {[
              {
                title: "Daily Dashboard",
                pain: <em className="text-gray-600 block text-center mx-auto">"What does my baby need now? Did I sleep enough? What should I do next?" — overwhelmed moms face constant overload.</em>,
              ...
              else if (feature.title === "Task Assistant") scaleClass = "scale-[1.0]";
      ...
      {/* AI Inside Section */}
      <section id="ai-inside" className="py-24 bg-white text-center">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-24 bg-gradient-to-br from-[#F8F6FC] to-[#EAE6F8] text-center">
        <div className="container mx-auto px-6 flex flex-col items-center">
          <div className="max-w-4xl mx-auto w-full">
            ...
            <div className="grid md:grid-cols-2 gap-12 justify-items-center">
              ...
              <div className="bg-white rounded-xl p-8 shadow-sm w-full">
                <form onSubmit={handleContactSubmit} className="space-y-6 flex flex-col items-center">
                  <div className="w-full text-center flex flex-col items-center">
                    <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2 text-center w-full">
                      Name
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-transparent transition-all duration-300 text-center"
                      placeholder="Enter your name"
                    />
                  </div>
                  <div className="w-full text-center flex flex-col items-center">
                    <label htmlFor="contact-email" className="block text-sm font-medium text-gray-700 mb-2 text-center w-full">
                      Email
                    </label>
                    <input
                      type="email"
                  ...
                  <div className="w-full text-center flex flex-col items-center">
                    <label htmlFor="message" className="block text-sm font-medium text-gray-700 mb-2 text-center w-full">
                      Message
                    </label>
                    <textarea
                      id="message"
                  ...
                  <button
                    type="submit"
                    className="w-full px-8 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl text-base font-medium shadow-sm hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 text-center"
                  >
                    Send Message
                  </button>
                </form>
              ...
              <div className="space-y-8 w-full flex flex-col items-center">
                <div className="bg-white rounded-xl p-8 shadow-sm text-center w-full flex flex-col items-center">
                  <h3 className="text-xl font-medium mb-6 text-gray-900 text-center w-full">Contact Information</h3>
